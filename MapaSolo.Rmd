---
title: "Seguimiento CNPV 2018 (`r format(Sys.time(), '%d de %B de %Y %X')`)"
output: 
...
leaflet(data= CONALPto) %>%
 ...
 addPolylines(data = DPTOS_lin, stroke = TRUE, color = "#000000",opacity = 1, weight= 1,group = "Límite departamental") %>%
  ...
  addLegend(position = "bottomleft", pal = tr.pal, values = Trans$Porcentaje,title = "Transmisión",opacity = 0.3, labels=c("0%","0.01 - 90%","90-100%","Mayor al 100%"))
