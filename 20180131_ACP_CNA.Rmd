...
plot(versincl["Incluida"], col = c("#bababa","#7fbc41"), border = "#7fbc41", axes = TRUE, key.size = lcm(4.5), main = "Localización de veredas incluidas en el ACP")
...
# Generando la matriz triangular inferior para visualización
upper<-cor_org
upper[upper.tri(cor_org)]<-0
upper<-as.data.frame(upper)

# Generando representación interactiva de la matriz de correlación
heatmaply(round(upper,2),scale_fill_gradient_fun = scale_fill_gradient2(low = "#a50026", high = "#313695", midpoint = 0),dendrogram="none",hide_colorbar = TRUE,column_text_angle=90, margins=c(75,70,NA,0),main=paste("Matriz de correlaciones"), cex.main= 0.1,fontsize_row = 7,fontsize_col = 8,cex.main=0.5)
...
corrplot(pc1$var$cor[,1:4],cex.main=0.7,method = c("square"),number.cex = 0.5,tl.cex=0.7,tl.col="gray31",cl.align="l",tl.offset = 0.1,col = rev(brewer.pal(5, "RdBu")),cl.cex=0.6,cl.ratio=0.5)
```
