...
A `r format(Sys.Date(), "%B %d de %Y ")` se han atendido . Se han recibido requerimientos de los 32 departamentos y el Distrito Capital distribuidos geográfica así:
